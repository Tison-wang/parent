...
public class MyClassLoader2 extends ClassLoader {
    ...
    public MyClassLoader2(String swapPath, Set<String> useMyClassLoaderLoad) {
    ...
    public static void main(String[] args) {
        ...
        new Timer().schedule(new TimerTask() {
            ...
            public void run() {
                ...
                MyClassLoader2 myClassLoader = new MyClassLoader2(swapPath, Sets.newHashSet(className));
                try {
